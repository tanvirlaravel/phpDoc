...
<h2 class="my-4 text-info text-center">Array</h2>

<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item m-1" role="presentation">
        <a class="nav-link active bg-primary text-white" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">array_change_key_case()</a>
    </li>
    <li class="nav-item m-1" role="presentation">
        <a class="nav-link bg-secondary text-white" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">array_column()</a>
    </li>
    <li class="nav-item m-1" role="presentation">
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        <img src="img/array/array_change_key_case.png" alt="">
        <img src="img/array/array_change_key_case1.png" alt="">
        <img src="img/array/array_change_key_case2.png" alt="">
    </div>
