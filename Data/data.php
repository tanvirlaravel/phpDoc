...
<div class="col-md-9">
	...
	<p>Data refers to distinct pieces of information</p>

	<p>Usually formatted and stored in a way that is concordant <span class="text-info"> (in agreement; consistent.) </span> with a specific purpose. </p>

	<p>Data can exist in various forms: as </p> 

	  <ul>
	  	<li>numbers or</li>
	  	<li>text recorded on paper</li>
	  	<li>as bits or bytes stored in electronic memory</li>
	  	<li>as facts living in a person’s mind</li>
	  </ul>

	<p>Data most commonly refers to information that is transmitted or stored electronically.</p>

	<hr>

	<p>
		Data can be defined as a representation of facts, concepts, or instructions in a formalized manner, which should be suitable for communication, interpretation, or processing by human or electronic machine.</p>
